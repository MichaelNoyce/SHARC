...
#define ACCEL_DPLFCFG_0 0<<3
#define ACCEL_DPLFCFG_1 1<<3
#define ACCEL_DPLFCFG_2 2<<3
#define ACCEL_DPLFCFG_3 3<<3
#define ACCEL_DPLFCFG_4 4<<3
#define ACCEL_DPLFCFG_5 5<<3
