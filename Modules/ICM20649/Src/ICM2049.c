...
imu_status_t ICM20649_Init_IMU(uint8_t g_fsr, uint8_t a_fsr, uint8_t dlpf_acc_coeff, uint8_t dlpf_gyro_coeff)
{
	...
	ICM20649_Set_Acc_DLPF(&hi2c1, ACCEL_DPLFCFG_0, ENABLE);
	ICM20649_Set_Gyro_DLPF(&hi2c1, GYRO_DPLFCFG_0, ENABLE);
...
imu_status_t ICM20649_Set_Sample_Rate(I2C_HandleTypeDef *hi2c)
{
	...
	if(HAL_I2C_Mem_Write(hi2c, IMU_Device_Address, ACCEL_SMPLRT_DIV_1, 1, &smplrtdiv, 2, 100) != HAL_OK)
	{
		return IMU_I2C_ERROR;
	}
